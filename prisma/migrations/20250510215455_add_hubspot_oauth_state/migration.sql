...
-- CreateTable
CREATE TABLE "HubSpotOAuthState" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "state" TEXT NOT NULL,
    "expiresAt" TIMESTAMP(3) NOT NULL,
    ...
    CONSTRAINT "HubSpotOAuthState_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "HubSpotAccount_hubId_key" ON "HubSpotAccount"("hubId");

-- CreateIndex
CREATE INDEX "HubSpotAccount_userId_idx" ON "HubSpotAccount"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "HubSpotOAuthState_state_key" ON "HubSpotOAuthState"("state");

-- CreateIndex
CREATE INDEX "HubSpotOAuthState_userId_idx" ON "HubSpotOAuthState"("userId");
...
-- AddForeignKey
ALTER TABLE "HubSpotOAuthState" ADD CONSTRAINT "HubSpotOAuthState_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
